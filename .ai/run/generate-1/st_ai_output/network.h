...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "model_no_quant"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x0f43b6c3927e1e45d232d9425acbf0f8"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x7b1604a3cfb3c1ea)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,122,40,1}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_HEIGHT      (122)
#define STAI_NETWORK_IN_1_WIDTH       (40)
#define STAI_NETWORK_IN_1_CHANNEL     (1)
#define STAI_NETWORK_IN_1_RANK        (3)
#define STAI_NETWORK_IN_1_SIZE        (4880)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (19520)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (23616)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (23616)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (23616)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (23616)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (39468)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (39468)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (39468)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (39468)
